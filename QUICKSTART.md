...
1. Tell your agent:
   ...
   > "Based on the context and problem statement we've discussed, give me a first-pass [prototype / spec / brief / plan]. Keep it focused on the core problem only and don't over-engineer this first version."
...
The [CHEAT_SHEET.md](./CHEAT_SHEET.md) has every command, prompt, template, and workflow on one page. Keep it open while you work.

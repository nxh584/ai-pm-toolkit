...
**You use ChatGPT or Claude but never in a structured way**
...
**You use AI regularly but every session starts from scratch**
...
**You're curious about AI editors but don't know where to start**
...
**You're already using Cursor, Claude Code, or Windsurf**

You're comfortable in an AI-native editor and want the full toolkit.

You're in the right place. Start with the main README and the QUICKSTART. The ide-setup/ directory has your config files.

Whichever level you start at, the toolkit is designed to grow with you. Each level ends with a specific next step when you're ready for it. There is no pressure to move faster than feels natural.
